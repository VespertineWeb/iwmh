...
subDomain='meusubdominio' ##Adicione o seu sub dominio (apenas início)
numberSequencial3Digites='001'  ##Adcione um numero Sequencial com 3 digitos não pode repetir de 000 a 999
mysqlTablePassword="senhadomysql" ##Adicone a senha que deseja utilizar para tabela do mysql
mysqlRootPassword="senharootmysql"	##Adicone a senha de root para o mysql (única)
...
echo "Aponte este domínio :$backendName.$domain"
echo "Aponte este domínio :$instName.$domain"
